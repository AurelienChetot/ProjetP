...
export default function Objectifs() {
  return (
    <div className="bg-stone-100 pt-16">
      ...
      <p className="pl-4 pr-4 pt-6 pb-2 text-center text-xl font-bold lg:pt-16">
        ● Trouver un <span className="text-customColor">Sens</span> de{" "}
        <span className="text-customColor">Direction</span>
      </p>
      <p className="pl-4 pr-4 pt-4 pb-2 text-center lg:pr-[30%] lg:pl-[30%] lg:pb-16">
      ...
      <p className="pl-4 pr-4 pt-2 pb-6 text-center font-bold lg:pr-[30%] lg:pl-[30%] lg:pb-16">
      ...
      <div className="bg-customColor mb-6 ml-2 mr-2 rounded-2xl lg:ml-80 lg:mr-80 lg:mb-16">
